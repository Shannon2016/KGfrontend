<template>
  <el-container>
    ...
    <el-main>
      ...
      <div class="header">
        视频转换为图像
        <el-button type="primary" class="darkBtn headbutton" size="small" @click="onUpload">打开视频</el-button>
        <el-button type="primary" class="darkBtn headbutton" size="small" @click="handleTransform">转换为图像</el-button>
      </div>
      <!-- 上传窗口-->
      ...
      >
        <div v-if="!flag" style="margin-left:50px;">提示：请先上传视频进行转换</div>
        <el-row v-if="isTrans">
        ...
        <el-row v-for="(item, index) in vedioList" v-bind:key="index">
          <el-col :span="isTrans?12:24">
              <div class="resultContainer">
                <div style="display:flex; flex-direction: row;flex-wrap:wrap; height:100%;width:100%;padding-right: 20px;">
                  ...
                  <div style="text-align: center;font-weight: bold;width: 100%">{{fileName}}</div>
                </div>
              </div>
          </el-col>
