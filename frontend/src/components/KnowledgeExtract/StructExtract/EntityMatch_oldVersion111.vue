...
export default {
  ...
  methods: {
    loadPastFlag() {
      //清空标记
      this.$http
        .post("http://39.102.71.123:30001/pic/loadMarkData")
        .then((res) => {
          console.log(res);
          //清空上次
          this.pastSumMap = {};
    ...
    modelTest() {
      this.loadingRes = true;
      this.$http
        .post("http://39.102.71.123:30001/pic/struct_test", {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        })
    ...
    entityMark() {
      ...
      // this.$http
      //   .post("http://39.102.71.123:30001/pic/start_entity_match", fd, {
      //     headers: {
      //       "Content-Type": "multipart/form-data",
      //     },
      //   })
    ...
    chooseTable() {
      ...
      this.loadingRes = true;
      this.$http
        .post("http://39.102.71.123:30001/pic/start_struct_label", fd, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        })
    ...
    submitMarks() {
      ...
      this.loadingRes = true;
      this.$http
        .post("http://39.102.71.123:30001/pic/struct_label_end", fd, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        })
    ...
    returnUnmarks() {
      ...
      fd.append("table", this.tableIndex);
      this.$http
        .post("http://39.102.71.123:30001/pic/submit_remain_data", fd, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        })
    ...
    showGraph() {
      ...
      let that = this;
      this.$http
        .post("http://39.102.71.123:30001/pic/show_structTuple", {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        })
    ...
    searchGraph() {
      ...
      this.$http
        .post("http://39.102.71.123:30001/pic/search_struct_data", fd, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        })
