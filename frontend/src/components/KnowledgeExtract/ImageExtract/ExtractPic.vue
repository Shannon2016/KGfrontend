<template>
  ...
  >
    ...
    <el-main>
      ...
      <div
        class="top-tip"
        style="textalign: left; clear: both; padding-left: 0"
      >
        <!-- <el-select
          v-model="fileIndex"
          placeholder="请选择测试目录"
        ...
        <el-dialog title="选择目录" :visible.sync="dialogVisible">
          <el-tree
            :data="treeData"
            :props="defaultProps"
        ...
        <el-button
          ...
          >加载测试数据</el-button
        >
        <span>已选择目录：{{ this.checkedFolder }}</span>
      </div>
...
export default {
  ...
  methods: {
    ...
    submitUpload() {
      ...
      // this.$http
      //   .post("http://39.102.71.123:30001/pic/pic_extract", fd, {
    ...
    showResults() {
      if (this.fileIndex == "") {
        ...
        this.$http
          .post("http://39.102.71.123:30001/pic/pic_test_results", fd, {
            headers: {
              "Content-Type": "multipart/form-data",
            },
          })
    ...
    modelTest() {
      ...
      fd.append("contents", this.fileIndex);
      this.$http
        .post("http://39.102.71.123:30001/pic/pic_test", fd, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        })
    ...
    loadList() {
      ...
      fd.append("contents", this.fileIndex);
      this.$http
        .post("http://39.102.71.123:30001/pic/load_picData", fd, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        })
    ...
    handleShow(row) {
      ...
      this.loadingRes = true;
      this.$http
        .post("http://39.102.71.123:30001/pic/view_picData", fd, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        })
    ...
    showHistory() {
      if (this.fileIndex == "") {
        ...
        fd.append("contents", this.fileIndex);
        this.$http
          .post("http://39.102.71.123:30001/pic/picTestHistory", fd, {
            headers: {
              "Content-Type": "multipart/form-data",
            },
          })
    ...
    handleAnalysis(row) {
      ...
      this.loadingRes = true;
      this.$http
        .post("http://39.102.71.123:30001/pic/pic_detect_predict", fd, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        })
